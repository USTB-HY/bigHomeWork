      ...
      <div class="cart-body">
        <ul class="cart-list" v-for="item in cartInfoList" :key="item.id">
          ...
          <li class="cart-list-con5">
            <a href="javascript:;" class="mins" @click.prevent="AddCart(item.skuId,-1)">-</a>
            <input
              autocomplete="off"
              type="text"
              :value="item.skuNum"
              ...
              class="itxt"
            />
            <a href="javascript:;" class="plus" @click.prevent="AddCart(item.skuId,+1)">+</a>
          </li>
...
export default {
  ...
  methods:{
    AddCart(skuId,skuNum) {
      this.mixinModiCart(skuId,skuNum)
      this.$nextTick(() => {
